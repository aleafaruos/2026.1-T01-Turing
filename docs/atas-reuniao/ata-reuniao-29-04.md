...
# Ações
Finalizar o documento de visão até sexta-feira.
Revisar e ajustar os cenários, backlog e descrições do projeto.
Verificar com o monitor se a seção de testes e qualidade de software precisa entrar no documento.
Estudar arquitetura de software para a discussão de segunda-feira.
Atualizar os diagramas que ainda faltam explicar no documento.
Acompanhar e alinhar as próximas sprints com foco primeiro em usuário/admin e depois nas salas/reservas.